...
def ha_list_entities_impl(domain: str = "", search: str = "") -> str:
...
def ha_get_state_impl(entity_id: str) -> str:
...
def ha_toggle_impl(entity_id: str) -> str:
...
def ha_turn_on_impl(entity_id: str) -> str:
...
def ha_turn_off_impl(entity_id: str) -> str:
...
def ha_send_notification_impl(message: str, title: str = "") -> str:

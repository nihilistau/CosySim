...
- Every NPC as a governed local LLM agent
- Interceptor / skill / MCP pipeline as the control plane
- Persistent world + knowledge flywheel (Nexus)
- Agentic-coding-at-scale of a large monorepo
...
Do not treat this README as the current product. Treat it as the field notebook an agent should mine for patterns, not clone as a starting app.

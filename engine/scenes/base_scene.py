...
from engine.scenes.base_scene_routes import BaseSceneRoutesMixin

_bslogger = logger  # Alias used by HUD/overlay/MCP helpers below
...
class BaseScene(BaseSceneRoutesMixin, ABC):
    """
    ...
    def load_scene(self, scene_id: str) -> None:
        ...
        try:
            ...
            logger.debug("Failed to register scene '%s' with MCPFramework", scene_asset.name, exc_info=True)
    ...
    def stop(self) -> None:
        ...
        try:
            ...
            logger.debug("Failed to persist character registry to DB on scene stop", exc_info=True)
    ...
    def get_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.debug("Failed to attach system monitor snapshot to health check", exc_info=True)
        return health

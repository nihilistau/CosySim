  ...
  class AnimState {
    ...
    _applyAnimState(time, dt) {
      ...
      if (this.currentState === 'sit') {
        ...
        // Lower hip to couch seat surface (~0.50); hipY≈0.82 → 0.50-0.82=-0.32
      ...
      if (this.currentState === 'lie') {
        ...
        // Lower to mattress level (~0.70); torsoY≈0.80 → 0.70-0.80=-0.10
        model.group.position.y = -0.10 * l + (model._baseY || 0);
      ...
      if (this.currentState === 'lounge') {
        ...
        // Lower to couch, semi-reclined
        model.group.position.y = -0.30 * l + (model._baseY || 0);
      ...
      if (this.currentState === 'warm') {
        ...
        // Seated on floor by fireplace
        model.group.position.y = -0.30 * w + (model._baseY || 0);
      ...
      if (this.currentState === 'bathe') {
        ...
        // In tub, partially submerged; tub interior ~0.35, torso 0.80
        model.group.position.y = -0.40 * b + (model._baseY || 0);
      ...
      if (this.currentState === 'kneel') {
        const k = t;
        model.group.position.y = -0.42 * k + (model._baseY || 0);
        if (model.legL) {
      ...
      if (this.currentState === 'kneel_sit') {
        const k = t;
        model.group.position.y = -0.50 * k + (model._baseY || 0);
        if (model.legL) {
      ...
      if (this.currentState === 'all_fours') {
        const a = t;
        model.group.position.y = -0.45 * a + (model._baseY || 0);
      ...
      if (this.currentState === 'crawl') {
        ...
        const c = t;
        model.group.position.y = -0.45 * c + (model._baseY || 0);
      ...
      if (this.currentState === 'lap_sit') {
        const l = t;
        model.group.position.y = -0.20 * l + (model._baseY || 0);
        if (model.legL) {
      ...
      if (this.currentState === 'going_down') {
        const g = t;
        model.group.position.y = -0.42 * g + (model._baseY || 0);
        if (model.legL) {
      ...
      if (this.currentState === 'missionary') {
        const m = t;
        model.group.position.y = -0.10 * m + (model._baseY || 0);
      ...
      if (this.currentState === 'doggy') {
        ...
        const dg = t;
        const p = this.walkPhase;
        model.group.position.y = -0.45 * dg + (model._baseY || 0);
      ...
      if (this.currentState === 'spooning') {
        const sp = t;
        model.group.position.y = -0.10 * sp + (model._baseY || 0);
      ...
      if (this.currentState === 'submissive') {
        const sb = t;
        model.group.position.y = -0.42 * sb + (model._baseY || 0);

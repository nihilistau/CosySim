...
A neon corporate operating-system desktop — mail, files, and a live AI
assistant. This package currently ships a bootable placeholder shell; the
full OS desktop is built out in later v1.62 tasks.
